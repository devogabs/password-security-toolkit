...
def main():
    ...
    check_parser.add_argument("password", type=str, help="The password that will be evaluated.")
    ...
    generate_parser.add_argument("--no-symbols", action="store_false", dest="use_symbols", help="Exclude symbols.")
